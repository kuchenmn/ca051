...
@Component("demoDelegate")
public class DemoDay3Delegate implements JavaDelegate {
    private final Logger LOGGER = LoggerFactory.getLogger(DemoDay3Delegate.class.getName());
